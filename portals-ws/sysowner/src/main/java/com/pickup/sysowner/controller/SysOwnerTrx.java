...
public class SysOwnerTrx {
	...
	public ResponseEntity<List<SysSubscriptionRequest>> findAllSubRequest() {
	...
	public ResponseEntity<SysSubscriptionRequest> findByIdSubReq(@PathVariable Integer id) {
		SysSubscriptionRequest entity = this.sysSubscribtionRequestService.findById(id);
		if (entity == null) {
	...
	@PutMapping(value = "/sub-request/{id}", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<SysSubscriptionRequest> updateSuRequest(@RequestBody SysSubscriptionRequest body,
			@PathVariable Integer id) {
		SysSubscriptionRequest updatedBody = this.sysSubscribtionRequestService.update(body, id);
