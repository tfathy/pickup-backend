...
public class SysOwner implements Serializable {
	...
	public String toString() {
		return "SysOwner [id=" + id + ", gnCountry=" + gnCountry + ", descAr=" + descAr + ", descEn=" + descEn
				+ ", address=" + address + ", notes=" + notes + ", shortNameAr=" + shortNameAr + ", shortNameEn="
				+ shortNameEn + ", whoColumn=" + whoColumn + "]";
	}

	public SysOwner(GnCountry gnCountry, String descAr, String descEn, String address, String notes, String shortNameAr,
			String shortNameEn, WhoColumn whoColumn) {
		super();
		this.gnCountry = gnCountry;
		this.descAr = descAr;
		this.descEn = descEn;
